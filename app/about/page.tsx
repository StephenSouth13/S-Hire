...
// SỬA LỖI: Nhập 'Variants' từ framer-motion để khai báo kiểu tường minh
...
// SỬA LỖI: Thêm kiểu 'Variants' vào hằng số
...
export default function EmployerPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-zinc-50 to-white dark:from-zinc-950 dark:to-zinc-900 text-zinc-800 dark:text-zinc-100 font-sans antialiased flex flex-col">
      <Header language={language} setLanguage={setLanguage} darkMode={false} setDarkMode={() => {}} />
      ...
      <main className="flex-grow">
        ...
        <section className="relative overflow-hidden bg-gradient-to-br from-indigo-800 to-purple-900 text-white py-28 md:py-40 px-6 text-center shadow-2xl">
          <div className="absolute inset-0 z-0 opacity-10">
            <Sparkles className="w-full h-full text-indigo-400 opacity-30 animate-pulse-slow" />
          </div>
          <motion.div
            ...
            {[
              {
                ...
                avatar: "https://placehold.co/150x150/FFD700/000000?text=A",
              },
              {
                ...
                avatar: "https://placehold.co/150x150/ADD8E6/000000?text=B",
              },
            ].map((testimonial, i) => (
              <motion.div
                key={i}
